...
Внимание! С мат.платами, заказанными примерно с августа 2021 года, данная версия биоса несовместима. Для восстановления требуется программатор.

    + При использовании серверной (ECC) памяти активна функция коррекции ошибок
    + Присутствует опция настройки таймингов ОЗУ

*v008:*
* + обновлено лого на официальное (взято с новой версии биос) и включено его отображение по умолчанию
