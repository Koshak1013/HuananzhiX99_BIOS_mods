...
Внимание! С мат.платами, заказанными примерно с августа 2021 года, данная версия биоса несовместима (информация неподтверждённая). Для восстановления требуется программатор.
