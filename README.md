...
1. Вопрос: Я привык использовать v3_payne_xx_xx.ffs или V3_MOF_xxxxxx.ffs, вшил по инструкции и получил кирпич. Почему?
...
2. Вопрос: В чём преимущество нового драйвера от S3TurboTool?
