...
*Если бипер по-прежнему издаёт звуки, то попробуйте также обработать модуль StatusCodePei (в разделе с PEI модулями). Если и это не поможет, то пожалуйста сообщите об этом в [Telegram группу](https://t.me/russian_xeon_community).*
